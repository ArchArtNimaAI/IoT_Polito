...
Communication occurs through connecting the user to the IoT gateway via the HTTP paradigm. Users can easily switch ON/OFF the apartment’s light remotely with the assistance of TelegramBot. 
