...
class Arduino:
    ...
    def myOnMessageReceived(self, paho_mqtt, userdata, msg):
        ...
        if msg.topic == "sensor":
            ...
            if movement:
                ...
                movement_numeric = 0
            requests.get(
                f'https://api.thingspeak.com/update?api_key=EQ9RQD25DPHUGM3L&field1={light}&field2={movement_numeric}')
    ...
    def GET(self, *uri):
        ...
        if uri[0] == "on":
            ...
            res = str(datetime.fromtimestamp(self.lastmove))
        else:
            res = open('index.html')
...
if __name__ == '__main__':
    ...
    # ----------------------------
    with open(os.path.join("..", "settings.json")) as f:  # ../settings.json or ..\settings.json on windows
        conf = json.load(f)
    topic = "sensor"
